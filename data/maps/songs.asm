MapSongBanks::
	...
	db MUSIC_ROUTE37, BANK(Music_Route37)
	...
	db MUSIC_ROCKET_HIDEOUT, BANK(Music_RocketHideout) ; ROCKET_HIDEOUT_B1F
	db MUSIC_ROCKET_HIDEOUT, BANK(Music_RocketHideout) ; ROCKET_HIDEOUT_B2F
	db MUSIC_ROCKET_HIDEOUT, BANK(Music_RocketHideout) ; ROCKET_HIDEOUT_B3F
	db MUSIC_ROCKET_HIDEOUT, BANK(Music_RocketHideout) ; ROCKET_HIDEOUT_B4F
	db MUSIC_ROCKET_HIDEOUT, BANK(Music_RocketHideout) ; ROCKET_HIDEOUT_ELEVATOR
	db MUSIC_ROCKET_HIDEOUT, BANK(Music_RocketHideout) ; UNUSED_MAP_CC
	db MUSIC_ROCKET_HIDEOUT, BANK(Music_RocketHideout) ; UNUSED_MAP_CD
	db MUSIC_ROCKET_HIDEOUT, BANK(Music_RocketHideout) ; UNUSED_MAP_CE
